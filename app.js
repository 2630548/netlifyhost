...
const UUID = process.env.UUID || '811e0051-95ea-47ca-a82e-ecb98f1e0763';
...
const NAME = process.env.NAME || 'gcp';
...
const httpServer = http.createServer((req, res) => {
  if (req.url === '/') {
    ...
    const vlessURL = `vless://UUID@104.16.0.0:443?encryption=none&security=tls&sni=${DOMAIN}&type=ws&host=${DOMAIN}&path=%2F#${NAME}`;
